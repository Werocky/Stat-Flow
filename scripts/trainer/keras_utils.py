...
#TODO: complete implementation of training in keras

def downloader(link, filename):
    linkToFile = link
    localDestination = "./static/yolo_weights/" + filename
...
def weightsToh5(cfg, weights, output):
...
def h5ToWeights(cfg, h5, output):
    keras_loader = KerasParser(cfg, h5, output)
